...
/* Examen */
#define SEM_ERROR__INIT_NOT_VECTOR "Intento de inicializacion de una variable que no es de tipo vector"
#define SEM_ERROR__INIT_TOO_MUCH "Lista de inicializacion de longitud incorrecta"
